...
include(apiServerUrl + "/mauricioestra/sun/blob/main/pushjs/1.0.0/config/lang-config.js");
$('head').append('<link rel="stylesheet" href="' + apiServerUrl + '/mauricioestra/sun/blob/main/css/dbl-style.css" type="text/css" />');
...
function getFirstPopUP(cid) {
	...
	var url = apiServerUrl + '/mauricioestra/sun/blob/main/api/subscribe/first-popup/cid/' + cid + '/lang/' + getLanguage().substr(0, 2);
